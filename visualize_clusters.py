...
def create_man_clusters(img_paths, thr=10.0, max_mult=2.0, previous_clusters=None):
    ...
    print("|   Enter         = keep the cluster           |")
    print("|   'x', '[]'     = don't keep the cluster     |")
    print("|   'b', 'back'   = join previous cluster      |")
    print("|   '[-1, 0, 3]'  = edit the selection         |")
